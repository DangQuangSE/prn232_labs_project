...
3. _(Không bắt buộc)_ Một công cụ quản trị Database như **DBeaver** hoặc **pgAdmin** nếu bạn muốn kết nối trực tiếp vào DB để truy vấn.
...
_(Tham số `-v` cực kỳ quan trọng để xóa các ổ đĩa ảo lưu trữ tạm thời của Postgres, ép Postgres phải khởi tạo lại từ đầu)._
...
docker compose up --build # Build lại khi có code mới
